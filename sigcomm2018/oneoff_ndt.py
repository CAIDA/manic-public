#usage: python oneoff_ndt.py "ddc_periods/bed-us.6453.11_11_2017.12_14_2017.66.110.96.129.ts ddc_periods/bed-us.66.110.96.129.win2.txt ddc_periods/bed-us.6453.11_11_2017.12_14_2017.66.110.96.129.near.ts ddc_periods/bed-us.66.110.96.129.ts ddc_periods/bed-us.66.110.96.129.ts"
...
#    last_second = 1494201600 + int(5.75* 86400) #end time x axis
    ...
    for j in range(number_files): 
            ...
            if j == 0: 
                    ...
                    ax.set_xlim([datetime.date(year, first_month, first_day), datetime.datetime(year, second_month, first_day+4,6)])    
                    date_fmt = '%m-%d-%y'
